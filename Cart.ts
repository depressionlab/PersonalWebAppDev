...
const getTotalPrice = (cart: cartItem[]) => REPLACE_ME;
...
// You should write your own test cases here!
// console.log(filterBy((item) => item['price'] > 300)(exampleCart))
